...
class ObsidianNoteParser:
    ...
    def parse_deck_from_obsidian_note_path(self, note_path: Path) -> str:
        relative_path = Path(os.path.relpath(path=note_path, start=self._config_handler.anki_folder))
